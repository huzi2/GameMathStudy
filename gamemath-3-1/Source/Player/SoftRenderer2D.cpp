...
void SoftRenderer::Update2D(float InDeltaSeconds)
{
	...
	const Vector2 inputVector = Vector2(input.GetAxis(InputAxis::XAxis), input.GetAxis(InputAxis::YAxis));
...
void SoftRenderer::Render2D()
{
	...
	static constexpr float lineLength = 500.f;
	const Vector2 lineStart = currentPosition * lineLength;
	const Vector2 lineEnd = currentPosition * -lineLength;
